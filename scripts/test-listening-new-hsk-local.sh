...
printf '%s\n' '[1/25] Kiểm tra cú pháp Listening'
...
printf '%s\n' '[15/25] Browser test audio controls và thanh nổi'
python3 scripts/test-listening-layout-browser.py

printf '%s\n' '[16/25] Browser test chép nguyên và sửa con trỏ'
python3 scripts/test-listening-full-dictation-browser.py

printf '%s\n' '[17/25] Browser test LDSN schema chung, resume và New HSK 15 bài'
python3 scripts/test-listening-sources-browser.py

printf '%s\n' '[18/25] Browser test nhập JSON, XLSX, CSV và TXT'
python3 scripts/test-import-core-browser.py

printf '%s\n' '[19/25] Browser test 课 – HSK & Giáo trình trong tab Thẻ'
python3 scripts/test-flashcard-curriculum-browser.py

printf '%s\n' '[20/25] Browser test Thẻ theo bài, AI Prompt Builder và Chép nhiều câu'
python3 scripts/test-patch2abc-browser.py

printf '%s\n' '[21/25] Browser test Dán kết quả AI trên mobile'
python3 scripts/test-ai-paste-browser.py

printf '%s\n' '[22/25] Shared Matching engine, Nối chữ và chạm để nghe'
node tests/test_matching_engine.js

printf '%s\n' '[23/25] Browser test Nối chữ mobile cho Nghe và Thẻ'
python3 scripts/test-matching-browser.py

printf '%s\n' '[24/25] Browser test Nối chữ mobile cho LDSN1-4'
