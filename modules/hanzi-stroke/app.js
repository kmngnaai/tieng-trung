...
(function initHskLearningTab(){
  ...
  async function mountGrammarPracticeUi(grammar, body){
    ...
    if(!grammarId || !body || !GrammarPracticeView || !GrammarPracticeUi || !GrammarPracticeAdapter) return;
