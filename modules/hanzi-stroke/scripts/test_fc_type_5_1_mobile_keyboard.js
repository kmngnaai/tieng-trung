...
const tests = [
  ...
  ['completion delay uses Han-character thresholds', app.includes('HSK_FLASHCARD_TYPING_SHORT_COMPLETION_DELAY_MS = 30000') && app.includes('HSK_FLASHCARD_TYPING_LONG_COMPLETION_DELAY_MS = 120000')],
  ['completion timer can be cancelled', app.includes('function cancelFlashcardTypingCompletionTimer')],
  ['tap-to-continue handler exists', app.includes('data-hsk-flashcard-typing-complete') && app.includes('completeFlashcardTypingTransitionNow()')],
