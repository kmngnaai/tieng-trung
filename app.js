...
function renderHome(){
  ...
  pageContent.innerHTML = `
    <div class="grid three">
      <article class="card">
        <h3>Bộ thủ 50</h3>
        <p>Module bộ thủ hiện tại được giữ nguyên, chuyển vào hệ Tiếng Trung lớn hơn.</p>
...
function renderRadicals(){
  pageTitle.textContent = 'Bộ thủ 50';
  pageSubtitle.textContent = 'Module bo-thu-50 hiện tại được nhúng riêng để không làm hỏng bản đang ổn.';

  pageContent.innerHTML = `
    <div class="card">
      <h3>Module Bộ thủ 50</h3>
      <p>Mở bên dưới hoặc mở trực tiếp nếu muốn toàn màn hình.</p>
      <a class="primary-btn" href="modules/bo-thu-50/index.html" target="_blank" rel="noopener">Mở toàn màn hình</a>
    </div>
    <iframe class="module-frame" src="modules/bo-thu-50/index.html" title="Bộ thủ 50"></iframe>
  `;
}
